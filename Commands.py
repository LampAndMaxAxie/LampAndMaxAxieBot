...
async def payoutCommand(message, args, isManager, discordId, guildId, isSlash=False):
    ...
    embed2 = discord.Embed(title="Individual Scholar Payout Results", description=f"Data regarding the payout", timestamp=datetime.datetime.utcnow(), color=discord.Color.blue())
